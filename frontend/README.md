...
3. Deploy the frontend to Vercel with `NEXT_PUBLIC_API_URL` pointing to the Render/Railway/Fly API domain.
4. Deploy FastAPI separately with production `JWT_SECRET_KEY`, `APP_ENCRYPTION_KEY`, `APP_BASE_URL`, and restricted `CORS_ORIGINS`.
